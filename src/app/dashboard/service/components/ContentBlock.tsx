    ...
    <div className="w-full p-6 bg-white rounded-xl">
      ...
      <div className="grid grid-cols-3 gap-5 mb-5">
        <select
          ...
          onChange={(e) => {
            ...
            setSlugData(e.target.value);
          }}
          id="slug"
          className="bg-white outline-none p-2 rounded-xl border border-gray-400'"
        >
      ...
      <div className="grid grid-cols-3 gap-5">
        <textarea
          ...
          className="w-full col-span-3 p-2 border border-gray-300 rounded-xl outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
        ></textarea>
